...
export default class Result extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      console.log(this.state.ElectionInstance.methods);
      ...
      for (let i = 1; i <= this.state.voterCount; i++) {
        const sum=await this.state.ElectionInstance.methods.voters(i-1).call();
      ...
      const data = encoder.encode(voter.voterAddress);
